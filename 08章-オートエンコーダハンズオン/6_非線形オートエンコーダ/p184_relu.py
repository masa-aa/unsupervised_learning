...
def plotResults(trueLabels, anomalyScores, returnPreds = False):
    ...
    plt.savefig('教師なし教科書/8章-オートエンコーダハンズオン/6_非線形オートエンコーダ/result/figure'+dt_now.strftime('%H_%M_%S')+'_No1.png')
    ...
    plt.savefig('教師なし教科書/8章-オートエンコーダハンズオン/6_非線形オートエンコーダ/result/figure'+dt_now.strftime('%H_%M_%S')+'_No2.png')
    plt.gca().clear()
...
for i in range(0,10):
    ...
    model.add(Dense(units=27, activation='relu', input_dim=29)) # tanh, sigmoidなど変えれる
