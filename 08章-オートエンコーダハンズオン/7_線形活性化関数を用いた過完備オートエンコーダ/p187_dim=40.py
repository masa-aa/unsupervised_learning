...
def plotResults(trueLabels, anomalyScores, returnPreds = False):
    ...
    plt.savefig('教師なし教科書/8章-オートエンコーダハンズオン/7_線形活性化関数を用いた過完備オートエンコーダ/result/figure'+dt_now.strftime('%H_%M_%S')+'_No1.png')
    ...
    plt.savefig('教師なし教科書/8章-オートエンコーダハンズオン/7_線形活性化関数を用いた過完備オートエンコーダ/result/figure'+dt_now.strftime('%H_%M_%S')+'_No2.png')
    plt.gca().clear()
