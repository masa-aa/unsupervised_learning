...
def plotResults(trueLabels, anomalyScores, returnPreds = False):
    ...
    plt.savefig('教師なし教科書/8章-オートエンコーダハンズオン/12_ノイズ除去オートエンコーダ/3_ReLU活性化関数を用いた2層ノイズ除去過完備オートエンコーダ/result/figure'+dt_now.strftime('%H_%M_%S')+'_No1.png')
    ...
    plt.savefig('教師なし教科書/8章-オートエンコーダハンズオン/12_ノイズ除去オートエンコーダ/3_ReLU活性化関数を用いた2層ノイズ除去過完備オートエンコーダ/result/figure'+dt_now.strftime('%H_%M_%S')+'_No2.png')
    plt.gca().clear()
...
# 平均0, 標準偏差1の正規分布で生成されたノイズの0.5倍を足す
noise_factor = 0.50
...
# Results
with open('教師なし教科書/8章-オートエンコーダハンズオン/12_ノイズ除去オートエンコーダ/3_ReLU活性化関数を用いた2層ノイズ除去過完備オートエンコーダ/result/result.txt', 'w') as f:
    print("Mean average precision over 10 runs: ", np.mean(test_scores), file=f)
    print("Coefficient of variation over 10 runs: ", np.std(test_scores)/ np.mean(test_scores), file=f)
