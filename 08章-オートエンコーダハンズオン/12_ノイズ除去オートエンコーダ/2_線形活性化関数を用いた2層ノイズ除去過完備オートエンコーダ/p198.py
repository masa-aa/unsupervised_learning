...
def plotResults(trueLabels, anomalyScores, returnPreds = False):
    ...
    plt.savefig('教師なし教科書/8章-オートエンコーダハンズオン/12_ノイズ除去オートエンコーダ/2_線形活性化関数を用いた2層ノイズ除去過完備オートエンコーダ/result/figure'+dt_now.strftime('%H_%M_%S')+'_No1.png')
    ...
    plt.savefig('教師なし教科書/8章-オートエンコーダハンズオン/12_ノイズ除去オートエンコーダ/2_線形活性化関数を用いた2層ノイズ除去過完備オートエンコーダ/result/figure'+dt_now.strftime('%H_%M_%S')+'_No2.png')
    plt.gca().clear()
...
# Results
with open('教師なし教科書/8章-オートエンコーダハンズオン/12_ノイズ除去オートエンコーダ/2_線形活性化関数を用いた2層ノイズ除去過完備オートエンコーダ/result/result.txt', 'w') as f:
