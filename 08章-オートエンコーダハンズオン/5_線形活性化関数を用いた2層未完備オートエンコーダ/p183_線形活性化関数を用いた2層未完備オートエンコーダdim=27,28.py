...
def plotResults(trueLabels, anomalyScores, returnPreds = False):
    ...
    plt.savefig('教師なし教科書/8章-オートエンコーダハンズオン/5_線形活性化関数を用いた2層未完備オートエンコーダ/result/dim=28,27/figure'+dt_now.strftime('%H_%M_%S')+'_No1.png')
    ...
    plt.savefig('教師なし教科書/8章-オートエンコーダハンズオン/5_線形活性化関数を用いた2層未完備オートエンコーダ/result/dim=28,27/figure'+dt_now.strftime('%H_%M_%S')+'_No2.png')
    plt.gca().clear()
...
for i in range(0,10):
    ...
    # Generate hidden layer with 28, 27 nodes, the same as the input layer
