...
overallAccuracy_kMeansDF2 = pd.DataFrame(data=[],index=[9, 49, \
                    99, 199, 299, 399, 499, 599, 699, 783], \
                    columns=['overallAccuracy'])
...
for cutoffNumber in [9, 49, 99, 199, 299, 399, 499, 599, 699, 783]:
    ...
    overallAccuracy_kMeansDF2.loc[cutoff] = overallAccuracy_kMeans
d= pd.DataFrame(data=[],index=[9, 49, \
                    99, 199, 299, 399, 499, 599, 699, 783], \
                    columns=['overallAccuracy','overallAccuracy2'])
d.loc[:,'overallAccuracy']=overallAccuracy_kMeansDF.loc[:,'overallAccuracy']
d.loc[:,'overallAccuracy2']=overallAccuracy_kMeansDF2.loc[:,'overallAccuracy']
d.plot()
plt.show()